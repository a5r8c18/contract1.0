...
const ContratoTrabajoIndeterminado = () => {
  const section1Ref = useRef<HTMLDivElement>(null); // DE UNA PARTE hasta PRIMERA
  const section2Ref = useRef<HTMLDivElement>(null); // SEGUNDA hasta DÉCIMOPRIMERA
  const section3Ref = useRef<HTMLDivElement>(null); // DÉCIMOSEGUNDA hasta final
  ...
  const exportToPDF = async () => {
    ...
    try {
      ...
      pdf.save("contrato_trabajo_indeterminado.pdf");
    } catch (error) {
          ...
          <div ref={section1Ref} className="pdf-section bg-white p-4">
            ...
            <section>
              ...
              <p className="mt-2">
                ...
                por tiempo indeterminado para la ejecución de un trabajo u obra
          ...
          <div ref={section2Ref} className="pdf-section bg-white p-4">
            ...
            <section>
              ...
              <p className="mt-2">
                ...
                {renderField("fechaInicio", "", "date")} y tendrá vigencia por
            ...
            <section>
              ...
              <p className="mt-2">
                ...
                Requiere su presencia física en la sede de EL EMPLEADOR.
                <br />
          ...
          <div ref={section3Ref} className="pdf-section bg-white p-4">
            <section>
              ...
              <p className="mt-2">
                ...
                <br />
                c. Por fuerza mayor que imposibilite la realización del trabajo
                para el cual fue contratado;
                <br />
                d. Aplicación de la medida disciplinaria de separación
                definitiva de la entidad por la comisión de una indisciplina
                laboral;
                <br />
                e. Fallecimiento de EL TRABAJADOR;
                <br />
                f. Disolución de EL EMPLEADOR.
                <br />
...
export default ContratoTrabajoIndeterminado;
